...
const STAGES: Stage[] = [
  {
    ...
    body: "An investor starts looking for money and your ad is there — in your markets, on the product they need, at the minute they need it. Search, social and the local map, working together.",
    state: "Stranger",
    metric: "In-market impression",
  },
  {
    title: "The funnel page makes you the obvious call",
    body: "Not your homepage. A page built for one loan product, showing your leverage, your timelines and your recent closings with real numbers — so they stop comparing rates and start believing you're the one who can actually fund it. This is where a stranger becomes someone who knows you and trusts you.",
    state: "Knows you",
    metric: "Inquiry submitted",
  },
  {
    title: "They ask, and we answer in five minutes",
  ...
  {
    title: "They get qualified against your box, not a generic form",
    body: "We build the questions around your lending criteria — address, price, ARV, close date, experience, cash to close, and whatever else you need to make a call. Asked one at a time, by text, the way a person would ask. Everything you need to pre-qualify them is captured before they ever reach your calendar.",
    state: "Pre-qualified",
    metric: "Deal sheet complete",
  },
  {
    title: "They land on your calendar",
    body: "Booked, confirmed, reminded. The deal sheet arrives before they do. If they no-show, we chase and rebook.",
    state: "Booked",
    metric: "Appointment held",
  },
  {
    title: "They come back",
    body: "Not ready this month goes into nurture until they are. Funded this month gets a review request and, at seasoning, a cash-out offer. One borrower, two closings.",
    state: "Repeat",
